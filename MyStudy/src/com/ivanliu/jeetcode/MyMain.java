...
public class MyMain {
	...
	public static void runJettCode() {
		...
		*/
		...
		System.out.println(sol.reverse(-100001));  // 1000000003 溢出
		
		// Subsets
		System.out.println("Subsets");
		llist = sol.subsets(new int[]{4,1,0});
		System.out.println("size of llist: " + llist.size());
		Utility.printListList(llist);
		
		// Subsets II
		System.out.println("Subsets II");
		llist = sol.subsetsWithDup(new int[]{1,2,2});
		System.out.println("size of llist: " + llist.size());
		Utility.printListList(llist);
		...
		System.out.println(sol.atoi("-9223372036854775808"));
